...
import '/SubMain_leave/main_leaveapp.dart';
import '/SubMain_leave/main_leavesta.dart';


class main_leave extends StatelessWidget {
  @override
            ...
            children: [
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => main_leaveapp()));
                  },
                  style: ButtonStyle(
                    backgroundColor:
